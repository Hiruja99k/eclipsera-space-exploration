      ...
      <div className="relative z-10 h-full flex items-center justify-center p-6">
        ...
        >
          <div className="flex flex-col-reverse items-center">
            <h1
              className="font-display text-4xl leading-tight md:text-[64px] md:leading-[72px] -tracking-[0.02em] font-normal mt-4"
            ...
            <div className="font-body text-xs font-normal uppercase tracking-[0.08em] leading-4">
              MOOOI PRESENTS
            </div>
          </div>
          <div className="mt-8">
